    ...
    <div className="auth-container">
      <div className="signup-card">
        ...
        <div className="tabs">
            ...
            >
              <div className="form-row">
                <input
                  ...
                  onChange={(e) =>
                    handleChange("patient", "firstName", e.target.value)
                  }
                  required
                />
                <input
                  ...
                  onChange={(e) =>
                    handleChange("patient", "lastName", e.target.value)
                  }
                  required
                />
              </div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("patient", "telephone", e.target.value)
                }
                required
              />
            ...
            >
              <div className="form-row">
                <select
                  ...
                  onChange={(e) =>
                    handleChange("doctor", "title", e.target.value)
                  }
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("doctor", "firstName", e.target.value)
                  }
                  required
                />
                <input
                  ...
                  onChange={(e) =>
                    handleChange("doctor", "lastName", e.target.value)
                  }
                  required
                />
              </div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("doctor", "speciality", e.target.value)
                }
                required
              />
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("doctor", "telephone", e.target.value)
                }
                required
              />
              ...
              <div className="form-row">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("doctor", "confirmPassword", e.target.value)
                  }
                  required
                />
              </div>
          ...
          {activeTab === "hospital" && (
            <form
              onSubmit={(e) => handleSubmit(e, "hospital")}
              className="signup-form"
            >
              <input
                type="text"
                ...
                onChange={(e) =>
                  handleChange("hospital", "name", e.target.value)
                }
                required
              />
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("hospital", "telephone", e.target.value)
                }
                required
              />
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("hospital", "registrationNumber", e.target.value)
                }
                required
              />
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("hospital", "email", e.target.value)
                }
                required
              />
              ...
              <div className="form-row">
                <input
                  ...
                  onChange={(e) =>
                    handleChange("hospital", "password", e.target.value)
                  }
                  required
                />
                <input
                  ...
                  onChange={(e) =>
                    handleChange("hospital", "confirmPassword", e.target.value)
                  }
                  required
                />
              </div>
